# -*- coding: utf-8 -*-
"""
Created on Mon Apr 3 17:23:22 2023
...
############### RANDOM WALK PLOTS#########################
################################################################
    plt.scatter(xfinal, yfinal, s = 0.5 , alpha = 0.5 , color='pink')
...
################################################################
    ...
    n, bins, patches = plt.hist(finald, 80, color ='pink', density = True, alpha=0.6, fill = True, hatch='/',histtype='step', linewidth=1, label = 'data')
